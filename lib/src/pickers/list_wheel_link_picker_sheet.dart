...
class ListWheelLinkPickerSheet extends StatefulWidget {
  const ListWheelLinkPickerSheet({
    super.key,
    required this.data,
    this.initialValues,
  ...
  @override
  State<ListWheelLinkPickerSheet> createState() =>
      _ListWheelLinkPickerSheetState();
}

class _ListWheelLinkPickerSheetState extends State<ListWheelLinkPickerSheet> {
  ...
  Widget build(BuildContext context) {
    return PickerBottomSheetShell(
      title: 'ListWheelScrollView 联动选择',
    ...
    return Stack(
      ...
      children: <Widget>[
        ...
        const Align(
          ...
          child: SizedBox(
            height: 46,
            child: IgnorePointer(child: PickerSelectionOverlay()),
          ),
        ),
      ],
    );
